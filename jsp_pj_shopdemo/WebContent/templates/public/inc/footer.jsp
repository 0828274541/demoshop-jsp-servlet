        ...
        <div class="carousel-holder" >
            ...
            <div id="owl-brands" class="owl-carousel brands-carousel">
                ...
                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="<%=request.getContextPath()%>/templates/public/assets/images/brands/brand-01.jpg" />
                    </a>
                </div><!-- /.carousel-item -->
                
                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="<%=request.getContextPath()%>/templates/public/assets/images/brands/brand-02.jpg" />
                    </a>
                </div><!-- /.carousel-item -->
                
                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="<%=request.getContextPath()%>/templates/public/assets/images/brands/brand-03.jpg" />
                    </a>
                </div><!-- /.carousel-item -->
                
                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="<%=request.getContextPath()%>/templates/public/assets/images/brands/brand-04.jpg" />
                    </a>
                </div><!-- /.carousel-item -->
    ...
    <div class="copyright-bar">
        <div class="container">
            <div class="col-xs-12 col-sm-6 no-margin">
                <div class="copyright">
                    &copy; <a href="index.jsp">Media Center</a> - all rights reserved
                </div><!-- /.copyright -->
            </div>
            <div class="col-xs-12 col-sm-6 no-margin">
                <div class="payment-methods ">
                    <ul>
                        <li><img alt="" src="<%=request.getContextPath()%>/templates/public/assets/images/payments/payment-visa.png"></li>
                        <li><img alt="" src="<%=request.getContextPath()%>/templates/public/assets/images/payments/payment-master.png"></li>
                        <li><img alt="" src="<%=request.getContextPath()%>/templates/public/assets/images/payments/payment-paypal.png"></li>
                        <li><img alt="" src="<%=request.getContextPath()%>/templates/public/assets/images/payments/payment-skrill.png"></li>
                    </ul>
                </div><!-- /.payment-methods -->
            </div>
        </div><!-- /.container -->
...
<!-- ============================================================= FOOTER : END ============================================================= -->	</div><!-- /.wrapper -->
	...
	<script src="<%=request.getContextPath()%>/templates/public/assets/js/jquery-1.10.2.min.js"></script>
	<script src="<%=request.getContextPath()%>/templates/public/assets/js/jquery-migrate-1.2.1.js"></script>
	<script src="<%=request.getContextPath()%>/templates/public/assets/js/bootstrap.min.js"></script>
	<script src="http://maps.google.com/maps/api/js?sensor=false&amp;language=en"></script>
	<script src="<%=request.getContextPath()%>/templates/public/assets/js/gmap3.min.js"></script>
	<script src="<%=request.getContextPath()%>/templates/public/assets/js/bootstrap-hover-dropdown.min.js"></script>
	<script src="<%=request.getContextPath()%>/templates/public/assets/js/owl.carousel.min.js"></script>
	<script src="<%=request.getContextPath()%>/templates/public/assets/js/css_browser_selector.min.js"></script>
	<script src="<%=request.getContextPath()%>/templates/public/assets/js/echo.min.js"></script>
	<script src="<%=request.getContextPath()%>/templates/public/assets/js/jquery.easing-1.3.min.js"></script>
	<script src="<%=request.getContextPath()%>/templates/public/assets/js/bootstrap-slider.min.js"></script>
    <script src="<%=request.getContextPath()%>/templates/public/assets/js/jquery.raty.min.js"></script>
    <script src="<%=request.getContextPath()%>/templates/public/assets/js/jquery.prettyPhoto.min.js"></script>
    <script src="<%=request.getContextPath()%>/templates/public/assets/js/jquery.customSelect.min.js"></script>
    <script src="<%=request.getContextPath()%>/templates/public/assets/js/wow.min.js"></script>
	<script src="<%=request.getContextPath()%>/templates/public/assets/js/scripts.js"></script>

	<!-- For demo purposes – can be removed on production -->
	
	<script src="<%=request.getContextPath()%>/templates/public/assets/js/switchstylesheet.js"></script>
	...
	<script>
		...
		document.getElementById("showCat"+tech).classList.add('active');
		
	</script>
	<!-- For demo purposes – can be removed on production : End -->

	<script src="<%=request.getContextPath()%>/templates/public/assets/js/button.js"></script>

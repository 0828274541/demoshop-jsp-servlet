...
<html lang="en">
	<head>
	    ...
	    <title>MediaCenter - Shop Mobile</title>

	    <!-- Bootstrap Core CSS -->
	    <link rel="stylesheet" href="<%=request.getContextPath()%>/templates/public/assets/css/bootstrap.min.css">
	    
	    <!-- Customizable CSS -->
	    <link rel="stylesheet" href="<%=request.getContextPath()%>/templates/public/assets/css/main.css">
	    <link rel="stylesheet" href="<%=request.getContextPath()%>/templates/public/assets/css/green.css">
	    <link rel="stylesheet" href="<%=request.getContextPath()%>/templates/public/assets/css/owl.carousel.css">
		<link rel="stylesheet" href="<%=request.getContextPath()%>/templates/public/assets/css/owl.transitions.css">
		<link rel="stylesheet" href="<%=request.getContextPath()%>/templates/public/assets/css/animate.min.css">

		<!-- Demo Purpose Only. Should be removed in production -->
		<link rel="stylesheet" href="<%=request.getContextPath()%>/templates/public/assets/css/config.css">

		<link href="<%=request.getContextPath()%>/templates/public/assets/css/green.css" rel="alternate stylesheet" title="Green color">
		<link href="<%=request.getContextPath()%>/templates/public/assets/css/blue.css" rel="alternate stylesheet" title="Blue color">
		<link href="<%=request.getContextPath()%>/templates/public/assets/css/red.css" rel="alternate stylesheet" title="Red color">
		<link href="<%=request.getContextPath()%>/templates/public/assets/css/orange.css" rel="alternate stylesheet" title="Orange color">
		<link href="<%=request.getContextPath()%>/templates/public/assets/css/navy.css" rel="alternate stylesheet" title="Navy color">
		<link href="<%=request.getContextPath()%>/templates/public/assets/css/dark-green.css" rel="alternate stylesheet" title="Darkgreen color">
		...
		<!-- Icons/Glyphs -->
		<link rel="stylesheet" href="<%=request.getContextPath()%>/templates/public/assets/css/font-awesome.min.css">
		<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
		<!-- Favicon -->
		<link rel="shortcut icon" href="<%=request.getContextPath()%>/templates/public/assets/images/favicon.ico">

		<!-- HTML5 elements and media queries Support for IE8 : HTML5 shim and Respond.js -->
		<!--[if lt IE 9]>
			<script src="<%=request.getContextPath()%>/templates/public/assets/js/html5shiv.js"></script>
			    ...
			    <div class="container">
			        <div class="col-xs-12 col-sm-6 no-margin">
			            <ul>
							...
							<li><a href="<%=request.getContextPath()%>/public/checkorder">Theo dõi đơn hàng</a></li>
			            </ul>
			        </div><!-- /.col -->
			        ...
			        <div class="col-xs-12 col-sm-6 no-margin">
			            <ul class="right">
			                ...
			                <li><a href="<%=request.getContextPath()%>/admin/index">Về Admin</a></li>
    			...
    			<div class="container no-padding">
					<div class="col-xs-12 col-md-3 logo-holder">
						...
						<div class="logo">
							...
							<!--<img alt="logo" src="<%=request.getContextPath()%>/templates/public/assets/images/logo.svg" width="233" height="54"/>-->
					...
					<div class="col-xs-12 col-md-6 top-search-holder no-margin">
						<div class="contact-row">
							<div class="phone inline">
								<i class="fa fa-phone"></i> (+84) 2827 4541
							</div>
							<div class="contact inline">
								<i class="fa fa-envelope"></i> contact@<span class="le-color">manhcuong.vn.1805@gmail.com</span>
							</div>
						</div><!-- /.contact-row -->
						<!-- ============================================================= SEARCH AREA ============================================================= -->
						<div class="search-area">
						
						    <form method="post" action="<%=request.getContextPath()%>/public/search">
						        <div class="control-group">
						        
						            <input class="search-field" type="search" name="searchResult" placeholder="Nhập sản phẩm cần tìm" value="<%if(request.getAttribute("searchResult")!=null){out.print(request.getAttribute("searchResult"));}%>" required/>
					...
					<div class="col-xs-12 col-md-3 top-cart-row no-margin">
						<div class="top-cart-row-container">
							...
							<%List<OrderDetail> odList = new ArrayList();
									...
									odList = (ArrayList)session.getAttribute("cartList");}
							%>
						            <a id="eventAddCart" class="dropdown-toggle" data-toggle="dropdown" href="#">
						                <div  class="basket-item-count">
						                    <span class="count"><%=odList.size()%></span>
						                    <img src="<%=request.getContextPath()%>/templates/public/assets/images/icon-cart.png" alt="" />
						                </div>
						                ...
						                <div class="total-price-basket">
						                    ...
						                    <%if(odList.size()>0){ 
						                        ...
						                        <span class="value"><div id = "mydiv1" ><%=format.format(totalMoney)%></div></span>
						            ...
						            <ul class="dropdown-menu" >
						                ...
						                <%if(odList.size()>0){ 
					                    	for(OrderDetail od : odList){ %>
					                    <li id="<%=od.getProduct().getId() %>">	
						                    <div class="basket-item">
						                        <div class="row">
						                            <div class="col-xs-4 col-sm-4 no-margin text-center">
						                            	
						                                <div class="thumb">
						                                <a href="<%=request.getContextPath()%>/public/detail?id=<%=od.getProduct().getId()%>">
						                                    <img alt="" height="50px" width="50px" src="<%=request.getContextPath()%>/uploads/<%=proImgDAO.getItemByProductId(od.getProduct().getId()).getName()%>" />
						  								 </a>
						                                </div>
						                            ...
						                            <div class="col-xs-8 col-sm-8 no-margin">
						                                ...
						                                <%if(od.getProduct().getSaleOff()!=0) {%>
						                                <div class="price"><%=format.format(od.getProduct().getSaleOff())%> x <%=od.getQuantity()%></div>
						                                <%}else{ %>
						                                <div class="price"><%=format.format(od.getProduct().getPrice())%> x <%=od.getQuantity()%></div>
						                                <%} %>
						                            </div>
						                        </div>
						                        <a class="close-btn xoa" onclick='dellItem(this)' id="<%=od.getProduct().getId()%>" href="#">Xoa</a>
						                    </div>
						                  </li>   
						                 <%}} %>
						                    ...
						                    <div class="basket-item">
						                        <div class="row">
						                            <div class="col-xs-12 col-sm-6">
						                                <a href="<%=request.getContextPath() %>/public/cart" class="le-button inverse">Giỏ hàng</a>
						                            </div>
							                            <div class="col-xs-12 col-sm-6">
							                                <a href="<%=request.getContextPath() %>/public/checkout" class="le-button">Mua hàng</a>
							                            </div>
							                        </div>
							                    </div>
							                </li>
